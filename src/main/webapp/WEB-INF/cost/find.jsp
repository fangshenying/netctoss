        ...
        <script language="javascript" type="text/javascript">
            ...
            function startFee(btn) {
                ...
                if(r){
	                ...
	                location.href="modifyStatus.do?id="+ s;
				}
            }
            //删除
            function deleteFee(btn) {
				...
				if(r){
	                ...
	                var tds = tr.getElementsByTagName("td");
	                var s = tds[0].innerHTML;
	                location.href="toDeleteCost.do?id="+ s;
				}
            }
        </script>        
    </head>
                ...
                <div id="data">            
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>${c.baseCost }</td>
                            <td>${c.unitCost }</td>
                            <fmt:formatDate value="${c.creatime }" pattern="yyyy-MM-dd HH:mm:ss" var = "creatime"/>
                            <td>${creatime }</td>
                            <fmt:formatDate value="${c.startime }" pattern="yyyy-MM-dd HH:mm:ss" var = "startime"/>
                            <td>${startime }</td>
                            <td>
